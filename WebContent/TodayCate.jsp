...
<title>Insert title here</title>
	...
	<script type="text/javascript">
	 	...
	 	function start(){
			...
			if(h==""||h==null){
			window.location="searchByUserIdlikecate.action?pageNumber=1&user_id=1";
			}
			} 
...
<!--  -->
	...
	<div id="layer2">
		...
		<img alt="" src="images/img_bg_1.jpg" width="100%" height="695px">
		<img alt="" src="images/img_bg_1.jpg" width="100%" >
	</div>
	<!--透明度图层  -->
	<div id="layer3"></div>
	...
	<p align="center"><font style="color:#FBB490;font-family:华文行楷;font-size:60px;">美食推荐</font></p>
	<p align="center"><font style="color:#FBB490;font-family:方正姚体;font-size:20px;">小瓷碗盛了滑滑的老豆腐，被切成细丁的胡萝卜懒懒的趴在上面荡漾，薄薄的手抓饼裹泡满满着汤汁被味蕾抓住</font></p>
	<p align="center"><font style="color:#FBB490;font-family:方正姚体;font-size:20px;">嫩嫩的香菜就在舌尖炸开了花，早上好啊.</font></p>
	<!-- 每日推荐图片 -->
	<div id="layer10">
	<!-- 1.获取用户ID推荐美食 -->	
	<!-- 2.获取美食ID为了给下一个页面传值 -->
	<table>
		<tr>
		<input type="hidden" id="h" value="${catetype}"/><!--设置hot隐藏域  -->
	...
	<a style="color: #808080" href="searchByUserIdlikecate.action?pageNumber=1&user_id=${userByTel.user_id}">首页</a>
	<a style="color: #808080" href="searchByUserIdlikecate.action?pageNumber=${pageNumber-1}&user_id=${userByTel.user_id}">上翻</a>
	<a style="color: #808080" href="searchByUserIdlikecate.action?pageNumber=${pageNumber+1}&user_id=${userByTel.user_id}">下翻</a>
	<a style="color: #808080" href="searchByUserIdlikecate.action?pageNumber=${count}&user_id=${userByTel.user_id}">尾页</a>
	
	</div>
	<!-- 留白底部文字 -->
	<div id="layer11" align="center">
	<font style="font-size:30px;color:#FBB490;">“ Their high quality of service makes me</font><br>
	<font style="font-size:30px;color:#FBB490;">back over and over again!”</font><br><br>
	<font style="font-size:15px;color:#FBB490;">— John Doe, CEO of XYZ Co.</font>
	</div>
	</div>
	<!-- 顶部导航栏<hr> -->
	<div id="layer5">
	...
	<div id="layer8">
		...
		<font style="color:#FBB448;font-family:方正姚体;font-size:25px;">您还在为今天吃什么而烦恼吗？</font>
	</div>
	<!-- 最下部文字 -->
	<div id="layer12">
