...
<body>
	...
	<!-- 中间留白地方文本 -->
	<div id="layer10">
		<a href="OnlineMeal_businessEnter.jsp"><img alt="" src="images/111.bmp">&nbsp;&nbsp;&nbsp;&nbsp;</a>
		<c:if test="${bus.business_name!=null}">
			<a href="searchBusinessByNamePerson.action?business_name=${bus.business_name}">
		</c:if>
		<c:if test="${bus.business_name==null}">
			<a href="#" class="business1">
		</c:if>
		<img alt="" src="images/222.bmp">&nbsp;&nbsp;&nbsp;&nbsp;</a>
		
		<c:if test="${bus.business_name!=null}">
			<a href="searchMenuByBusiness.action?business_id=${bus.business_id}">
		</c:if>
		<c:if test="${bus.business_name==null}">
			<a href="#" class="business1">
		</c:if>
			<img alt="" src="images/333.bmp"></a> 
	...
	<div id="layer13">
		...
		<c:set value="${bus}" scope="session" var="bus"/>
	</form>
	</div>
	<!-- 商家登陆框显示和隐藏 -->
